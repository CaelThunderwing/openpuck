...
This Documentation is largely unedited from https://github.com/xbb/openpuck/tree/feat/og-xbox-mode. 
the Work done to support Xbox 360 Controller support was largely born as i wished to be able to use the 2026 Steam controller on an Xbox 360. I'm no developer, this is 100% "Vibe Coded." OpenPuck itself is Vibecoded. and since Valve does not separately sell replacement pucks. this is the first AI Project i support. the only thing i claim here is just spending a week troubleshooting with ChatGPT to get this working. OG Xbox Mode is thanks to XBB for Implementing OG Xbox Support. OpenPuck is thanks to the work done with whatever AI Model safijari used for the project. this has largely only been tested with the Pro Micro NRF52840 Micro controller board. only Costs i threw into this outside time, was 16$ for a 6 pack of the boards + 1 month for OpenAI's ChatGPT Plus as this would of taken Months on the free tier.  Semi unedited Readme minus any relevance to this Repo is below. 
