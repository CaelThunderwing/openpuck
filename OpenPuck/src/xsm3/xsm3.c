...
#ifndef XSM3_INIT_DIAG_STAGE
#define XSM3_INIT_DIAG_STAGE 255
#endif
...
static uint32_t xsm3_prng = 0x6D2B79F5u;

for (i = 0; i < 0x10; i++) {
    xsm3_prng ^= xsm3_prng << 13;
    xsm3_prng ^= xsm3_prng >> 17;
    xsm3_prng ^= xsm3_prng << 5;
    xsm3_random_controller_data[i] = (uint8_t)xsm3_prng;
}
